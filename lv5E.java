...
public class lv5E extends JFrame implements Runnable, KeyListener {
    ...
    public lv5E(int lives, AudioClip bcc){
        super();
        this.bcc=bcc;
        this.lives=lives;
        boi = new Playaaa(new Rectangle(345,20,20,20),Color.CYAN);
