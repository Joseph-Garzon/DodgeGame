...
public class lv2 extends JFrame implements Runnable, KeyListener {
    ...
    public lv2(int lives, AudioClip bcc){
        super();
        this.lives=lives;
        this.bcc=bcc;
        ...
        bos.add(new UpDownBox(new Rectangle(300,350,20,20),
                UpDownBox.DOWN,Color.RED));
        bos.add(new UpDownBox(new Rectangle(200,180,20,20),
                UpDownBox.UP,Color.RED));
        bos.add(new UpDownBox(new Rectangle(180,200,20,20),
                UpDownBox.DOWN,Color.RED));
        bos.add(new LeftRightBox(new Rectangle(180,180,20,20),
                UpDownBox.LEFT,Color.RED));
        bos.add(new LeftRightBox(new Rectangle(200,200,20,20),
        ...
        was.add(new Wall(new Rectangle(20,120,60,20),Color.BLACK));
        was.add(new Wall(new Rectangle(340,280,60,20),Color.BLACK));
        addKeyListener(this);
        setSize(400,400);
