...
public class FinalScreenWB extends JFrame implements Runnable, KeyListener {
    ...
    public FinalScreenWB(int lives, AudioClip bcc){
        super();
        this.bcc=bcc;
        this.lives=lives;
        addKeyListener(this);
    ...
    public void paint(Graphics g){
        ...
        bg.drawString("You Win!!!",175,125);
        bg.drawString("You had "+lives+" lives left.",150,150);
        bg.setColor(Color.ORANGE);
        bg.drawString("AND YOU FOUND THE BONUS LEVEL / EASTER EGG!!!!!",50,175);
        bg.fillOval(150,260,100,125);
        bg.setColor(Color.BLUE);
